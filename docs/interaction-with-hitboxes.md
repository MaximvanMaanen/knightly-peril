...
`com.github.hanyaeger.knightlyperil.entities.swordfish`. In this package create a
...
`com.github.hanyaeger.knightlyperil.entities.swordfish` in the following way:
